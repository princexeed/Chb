...
const services = [
  ...
  { icon: 'fa-droplet', title: 'Blood Bank', tagline: 'Safe blood, safe transfusions — saving lives every day', image: 'https://images.unsplash.com/photo-1615461066841-6116e61059f4?w=800&q=80', desc: 'Safe blood collection, screening, storage and transfusion services — available 24/7 for emergencies and routine procedures.', category: 'Supportive Care', stats: { doctors: 4, patients: '5K+ units/yr' } },
